...
public class BillStoreRespository {
    ...
    public ArrayList<BillStore> getListForDateRange(ArrayList<BillStore> list, String startDateStr, String endDateStr) {
        ArrayList<BillStore> filteredList = new ArrayList<>();
    ...
    public ArrayList<BarEntry> displayBillForDateRange(ArrayList<BillStore> list, String startDateStr, String endDateStr) {
        ArrayList<BarEntry> barEntries = new ArrayList<>();
        ArrayList<BarBill> barBills = new ArrayList<>();
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy", Locale.getDefault());
