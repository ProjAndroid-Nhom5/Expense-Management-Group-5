...
public class Bill_Detail_Facility extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        remove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                confirmDeleteEcommerce(billFacility);
            }
        });
    }

    private void confirmDeleteEcommerce(BillFacility billFacility) {
        new AlertDialog.Builder(this)
                .setTitle("Delete Bill Facility")
                .setMessage("Are you sure you want to delete this Bill Facility?")
