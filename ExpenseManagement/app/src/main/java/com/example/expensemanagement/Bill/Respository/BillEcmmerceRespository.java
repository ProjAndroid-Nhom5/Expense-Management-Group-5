...
public class BillEcmmerceRespository {
    ...
    public ArrayList<BarEntry> displayAllBills(ArrayList<BillEcommerce> list) {
    ...
    public ArrayList<BarEntry> displayBillForCurrentMonth(ArrayList<BillEcommerce> list) {
        ArrayList<BarEntry> barEntries = new ArrayList<>();
        ArrayList<BarBill> barBills = new ArrayList<>();
        Calendar calendar = Calendar.getInstance();
    ...
    public ArrayList<BarEntry> displayBillForCurrentWeek(ArrayList<BillEcommerce> list) {
        ArrayList<BarEntry> barEntries = new ArrayList<>();
        ArrayList<BarBill> barBills = new ArrayList<>();
        Calendar calendar = Calendar.getInstance();
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy", Locale.getDefault());
