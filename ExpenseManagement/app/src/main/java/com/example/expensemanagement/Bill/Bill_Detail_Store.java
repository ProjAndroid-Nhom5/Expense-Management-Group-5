...
public class Bill_Detail_Store extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        remove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                confirmDeleteEcommerce(billStore);
            }
        });
    }

    private void confirmDeleteEcommerce(BillStore billStore) {
        new AlertDialog.Builder(this)
                .setTitle("Delete Bill Store")
                .setMessage("Are you sure you want to delete this Bill Store?")
