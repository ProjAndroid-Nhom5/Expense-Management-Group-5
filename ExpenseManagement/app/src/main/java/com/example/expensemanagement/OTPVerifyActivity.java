...
public class OTPVerifyActivity extends AppCompatActivity {
    final String TAG = OTPVerifyActivity.class.getName();
                ...
                if (resendEnable){
                    ...
                    PhoneAuthOptions options =
                            PhoneAuthOptions.newBuilder(mAuth)
                                    ...
                                    .setActivity(OTPVerifyActivity.this)                 // (optional) Activity for callback binding
        ...
        verifyBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (generateOtp.length() == 6){
                    ...
                    Toast.makeText(OTPVerifyActivity.this,"Enter OTP",Toast.LENGTH_SHORT);
                }
            }
        });
    }
    ...
    private void startCoutDownTimer(){
        ...
        new CountDownTimer(resentTime * 1000,1000){
            ...
            public void onFinish() {
                ...
                resentBtn.setTextColor(getResources().getColor(R.color.lightblue));
            }
        }.start();
    }
